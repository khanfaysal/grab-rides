        ...
        <Container>
            <Row>
                ...
                <Card style={{ width: '18rem' }}>
                    <Card.Header>Mirpur 1 <br/> Dhanmondi</Card.Header>
